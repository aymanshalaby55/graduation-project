        ...
        >
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              ...
              className="absolute left-full top-1/2 -translate-y-1/2 flex text-xs flex-col items-start justify-center rounded-md bg-black z-50 shadow-xl px-4 py-2"
            >
              {/* <div className="absolute inset-y-10 z-30 w-[20%] -left-px bg-gradient-to-b from-transparent via-emerald-500 to-transparent h-px " /> */}
